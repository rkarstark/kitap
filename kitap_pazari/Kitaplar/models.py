...
class Yorum(models.Model):
    ...
    yorum_sahibi = models.ForeignKey(User, on_delete=models.CASCADE, related_name='kullanici')
    yorum = models.TextField(blank=True, null=True)

    yaratilma_tarihii = models.DateTimeField(auto_now_add=True)
    guncellenme_tarihii = models.DateTimeField(auto_now=True) 
